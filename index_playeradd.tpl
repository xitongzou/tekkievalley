     <div id="rightcontent">
        ...
        <div id="right">
        <div align="center">
        <h2>Add New Player Profile</h2>
        <div id="simpleForm">
        <form name="player_settings" method="POST" action="index.php?m=playeradd">
        <fieldset>
        <legend>Profile</legend>
            <label for="profile">Profile Name: </label>
            <input name="profile" type="text" value="{$player.profile}" maxlength="20"><br>
        </fieldset>
        <fieldset>
        ...
        <div style="text-align: center;">
            <input type="submit" name="submit_add" value="Add Player Profile" class="button">
        </div>
        </form>
        </div>
        </div>
