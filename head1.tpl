...
<script language="javascript" type="text/javascript" src="{$baseurl}/js/expandvid.js"></script>
...
<div id="headnav">
  <div id="navbar">
    <div id="navcontainer">
      <ul>
        <li><a href="{seourl rewrite='' url='index.php'}" {$homecurrent}>{translate item='menu.home'}</a></li>
        {if $upload_module == 1}<li><a href="{seourl rewrite='upload' url='upload.php'}" {$uploadcurrent}>{translate item='menu.upload}</a></li>{/if}
        {if $video_module == 1}<li><a href="{seourl rewrite='videos' url='video.php?next=watch'}" {$watchcurrent}>{translate item='menu.videos'}</a></li>{/if}
        ...
        {if $community_module == 1}<li><a href="{seourl rewrite='community' url='members.php'}" {$communitycurrent}>{translate item='menu.community'}</a></li>{/if}
