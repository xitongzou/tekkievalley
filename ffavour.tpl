  <div id="leftside">
    <div id="myvideo">
      <div id="myvideo-title">
	  	<div class="titlepage">{translate item='ffavorites.my_friends_favorites'}</div>
        ...
        <div class="arrow-general">&nbsp;</div>
           {if $total gt "0"}
                ...
                <div class="myvideo {$colorLoop}">
                  ...
                  <div class="maindesc">
                      <p> <strong><a href="{$baseurl}/view_video.php?viewkey={$answers[i].vkey}">{$answers[i].title}</a></strong><br />
